...
Maintainers may use generative AI tools as assistants while working on labwc. Non-trivial assisted commits disclose the tool, model, and scope of the work.
